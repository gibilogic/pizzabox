...
/**
 * @version		    $Id: views/schemes/tmpl/default.php 2012-09-09 16:04:00Z zanardi $
	...
	<thead>
      ...
      <th nowrap="nowrap" style="width: 5%">
			...
			<th nowrap="nowrap">
 			...
 			<th nowrap="nowrap">
        <?php echo JHTML::_('grid.sort', 'PIZZABOX_CONTAINER', 'container_name', $this->filters['order_Dir'] , $this->filters['order'] ) ?>
      </th>
 			<th nowrap="nowrap" style="width: 5%">
