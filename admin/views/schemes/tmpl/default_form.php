...
/**
 * @version		    $Id: views/schemes/tmpl/default_form.php 2012-08-17 10:26:00Z zanardi $
...
<form action="index.php?option=com_pizzabox&controller=schemes" method="post" name="adminForm" id="adminForm">
	<table class="adminForm">
		<tr>
			<td><label for="name"><?php echo JText::_('PIZZABOX_NAME')?></label></td>
			<td><input id="name" name="name" type="text" value="<?php echo $this->row->name ?>"/></td>
		</tr>
		<tr>
	...
	<input type="hidden" name="controller" value="schemes" />
