...
<?php if( $this->tpl == 'confirmed' ) : ?>
  <?php if( $this->order['row']->delivery != '0000-00-00 00:00:00' ) {
...
<table id="order_details" class="adminlist">
	...
	<tr class="<?php echo $class ?>">
		...
		<td class="scheme">
			<?php if ( $part->scheme_image ) : ?>
				<span class="image"><img src="<?php echo $part->scheme_image?>" alt="Scheme image" /></span>
			<?php endif ?>
			<?php echo $part->scheme_name ?>
		</td>
		<td class="part">
