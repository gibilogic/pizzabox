...
<?php echo JHTML::_('grid.sort', 'PIZZABOX_ORDER_NUMBER', 'id', $this->filters['order_Dir'], $this->filters['order']) ?>
				...
				<th nowrap="nowrap">
<?php echo JText::_('PIZZABOX_ORDER_NAME') ?>
				</th>
				<th nowrap="nowrap">
...
<?php echo JText::_('Delete') ?>
	...
	<?php echo JText::_('PIZZABOX_ORDER_NUMBER') . ' ' . $row->id ?></a>
					</td>
	...
	<?php echo $row->ordering ?>
					...
					<td align="center">
						<a href="#delete" onclick="if (confirm('<?php echo JText::_('PIZZABOX_CONFIRM_DELETE') ?>')) {
									return listItemTask('cb<?php echo $k ?>', 'remove')
								}">
